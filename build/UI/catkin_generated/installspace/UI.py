...
Line1.create_line(920,20 , 920,700 ,  1280,700 , 1280,20 , 920,20 , width=1, fill="#DCDCDC")

Line1.create_line(920,726 , 920,919 ,  1280,919 , 1280,726 , 920,726 , width=1, fill="#DCDCDC")
...
RoundTxt_Lab.place(x=940, y=360, width=320, height=338)

######################作者信息部分###########################

MyMsg = tk.Label(MainWindows, text="作者：Akai \n 指导老师：陈晨 \n 特别鸣谢：Myaki、agou", font=('楷体',12), background='white')
MyMsg.place(x=940, y=750, width=320, height=100)
